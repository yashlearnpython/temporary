...
# sync rom
repo init --depth=1 -u git://github.com/Palladium-OS/platform_manifest.git -b eleven

git clone https://github.com/sushmit1/mainfest_personal.git --depth=1 -b master .repo/local_mainfest
